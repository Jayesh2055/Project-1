...
// Define types here for self-contained code in Canvas environment
interface User {
  id: string;
  name: string;
  email: string;
...
const mockUsers: User[] = [
  { id: '1', name: 'Dr. Kavita Sharma', email: 'kavita@example.com', role: 'doctor', specialization: 'Cardiology', department: 'Cardiology' },
  { id: '2', name: 'Dr. Manoj Kumar', email: 'manoj@example.com', role: 'doctor', specialization: 'Neurology', department: 'Neurology' },
  { id: '3', name: 'Dr. Asha Verma', email: 'asha@example.com', role: 'doctor', specialization: 'Pediatrics', department: 'Pediatrics' },
  { id: '4', name: 'Dr. Pooja Gupta', email: 'pooja@example.com', role: 'doctor', specialization: 'Orthopedics', department: 'Orthopedics' },
  { id: '5', name: 'Dr. Neha Singh', email: 'neha@example.com', role: 'doctor', specialization: 'Dermatology', department: 'Dermatology' },
  { id: '6', name: 'Suresh Patel', email: 'suresh@example.com', role: 'patient' },
  { id: '7', name: 'Meena Sharma', email: 'meena@example.com', role: 'patient' },
  { id: '8', name: 'Vikram Singh', email: 'vikram@example.com', role: 'admin' },
];

const mockAppointments: Appointment[] = [
  { id: '1', patientId: '6', doctorId: '1', date: '2023-06-20', time: '09:00', type: 'Checkup', status: 'completed', patientName: 'Suresh Patel', doctorName: 'Dr. Kavita Sharma' },
  { id: '2', patientId: '7', doctorId: '2', date: '2023-06-21', time: '10:30', type: 'Consultation', status: 'completed', patientName: 'Meena Sharma', doctorName: 'Dr. Manoj Kumar' },
  { id: '3', patientId: '6', doctorId: '3', date: '2023-06-22', time: '14:00', type: 'Follow-up', status: 'cancelled', patientName: 'Suresh Patel', doctorName: 'Dr. Asha Verma' },
  { id: '4', patientId: '7', doctorId: '4', date: '2023-06-23', time: '11:15', type: 'Checkup', status: 'scheduled', patientName: 'Meena Sharma', doctorName: 'Dr. Pooja Gupta' },
  { id: '5', patientId: '6', doctorId: '5', date: '2023-06-24', time: '15:45', type: 'Consultation', status: 'scheduled', patientName: 'Suresh Patel', doctorName: 'Dr. Neha Singh' },
  { id: '6', patientId: '7', doctorId: '1', date: '2023-06-25', time: '09:30', type: 'Follow-up', status: 'scheduled', patientName: 'Meena Sharma', doctorName: 'Dr. Kavita Sharma' },
  { id: '7', patientId: '6', doctorId: '2', date: '2023-06-26', time: '13:00', type: 'Checkup', status: 'scheduled', patientName: 'Suresh Patel', doctorName: 'Dr. Manoj Kumar' },
  { id: '8', patientId: '7', doctorId: '3', date: '2023-06-27', time: '16:30', type: 'Consultation', status: 'scheduled', patientName: 'Meena Sharma', doctorName: 'Dr. Asha Verma' },
  { id: '9', patientId: '6', doctorId: '4', date: '2023-06-28', time: '10:00', type: 'Follow-up', status: 'scheduled', patientName: 'Suresh Patel', doctorName: 'Dr. Pooja Gupta' },
  { id: '10', patientId: '7', doctorId: '5', date: '2023-06-29', time: '14:45', type: 'Checkup', status: 'scheduled', patientName: 'Meena Sharma', doctorName: 'Dr. Neha Singh' },
];
