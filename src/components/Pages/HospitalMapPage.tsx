...
const HospitalMapPage: React.FC = () => {
  ...
  // Here, we use an iframe for demonstration
  const mapSrc = `https://www.google.com/maps/embed/v1/view?key=YOUR_API_KEY&center=22.9734,78.6569&zoom=5&maptype=${mapType}`;
